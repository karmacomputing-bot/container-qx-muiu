...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qx-muiu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qx-muiu.containers.anotherwebservice.com/
...
```
git clone git@github.com:karmacomputing-bot/container-qx-muiu.git
cd container-qx-muiu
```
...
```
docker attach container-qx-muiu
```
